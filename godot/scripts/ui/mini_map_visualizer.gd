...
func _centrar_camara() -> void:
	...
	var tam_mapa = (max_p - min_p) + Vector2(TILE_SIZE_WIDTH, TILE_SIZE_HEIGHT)
	var zoom_f = min(max_zoom_width / tam_mapa.x, max_zoom_height / tam_mapa.y) * 0.90
