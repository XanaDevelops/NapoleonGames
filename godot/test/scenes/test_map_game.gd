    ...
    for y in range(map_res.tamY):
        for x in range(map_res.tamX):
            if randi() % 2 == 0:
                ...
                card_res.hp = 10
                card_res.desc = "Donec ut enim molestie, auctor risus at, ultrices arcu. Praesent blandit id ipsum ac volutpat. Nam pretium diam augue, ut condimentum massa imperdiet at. 
                Praesent id vulputate justo, at porta ex. Ut et ultrices arcu, ac dictum nulla. Integer feugiat nulla justo, in tristique mi elementum nec. Maecenas semper feugiat turpis sit amet aliquet. 
                Duis sed semper turpis, nec sodales risus. Mauris fermentum ligula at tortor congue porta. 
                Curabitur interdum tellus sed neque tristique, in dictum metus gravida. Integer mollis eu lacus in maximus."
